...
export class UsersController {
  ...
  async update(
    ...
    // Hedef kullanıcının mevcut rollerini kontrol et
    ...
    // Eğer hedef kullanıcıya SUPER_ADMIN rolü verilmeye çalışılıyorsa engelle
    if (hasSuperAdminRole && user.email !== 'mehmet_developer@hotmail.com') {
      throw new ForbiddenException('SUPER_ADMIN rolü sadece özel kullanıcılara verilebilir');
    }
